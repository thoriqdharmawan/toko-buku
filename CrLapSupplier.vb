...
Public Class CrLapSupplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Toko_Buku_dan_ATK.CrLapSupplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLapSupplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLapSupplier = New CrLapSupplier()
        rpt.Site = Me.Site
        Return rpt
    End Function
