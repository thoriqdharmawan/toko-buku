...
Public Class CrLapPelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Toko_Buku_dan_ATK.CrLapPelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLapPelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLapPelanggan = New CrLapPelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
