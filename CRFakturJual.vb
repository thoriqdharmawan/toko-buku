...
Public Class CRFakturJual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Toko_Buku_dan_ATK.CRFakturJual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFakturJual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFakturJual = New CRFakturJual()
        rpt.Site = Me.Site
        Return rpt
    End Function
