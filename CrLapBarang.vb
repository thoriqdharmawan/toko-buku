...
Public Class CrLapBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Toko_Buku_dan_ATK.CrLapBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLapBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLapBarang = New CrLapBarang()
        rpt.Site = Me.Site
        Return rpt
    End Function
